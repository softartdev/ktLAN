Pod::Spec.new do |spec|
    ...
    if !Dir.exist?('build/cocoapods/framework/ComposeAppFramework.framework') || Dir.empty?('build/cocoapods/framework/ComposeAppFramework.framework')
        ...
        Kotlin framework 'ComposeAppFramework' doesn't exist yet, so a proper Xcode project can't be generated.
    ...
    spec.pod_target_xcconfig = {
        ...
        'PRODUCT_MODULE_NAME' => 'ComposeAppFramework',
    }
                
    spec.script_phases = [
        {
            :name => 'Build ComposeAppCocoaPod',
